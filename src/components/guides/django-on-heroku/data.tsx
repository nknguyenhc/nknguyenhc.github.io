...
export class Image {
  src: string;
  caption: string;
  constructor({ src, caption }: { src: string; caption: string }) {
    this.src = src;
...
export class UnorderedList {
  list: Array<string>;
  constructor({ list }: { list: Array<string> }) {
    this.list = list;
  }
}
    ...
    },
    {
      ...
      body: [
        ...
        new Image({
          ...
          caption:
            'I personally use this app which does not require a subscription fee.',
        }),
        new Paragraph({
    ...
    },
    {
      ...
      body: [
        ...
        new Image({
          src: createNewApp,
          caption:
            'Heroku dashboard where you can start connecting to your Github repo and deploy.',
        }),
        new Paragraph({
    ...
    },
    {
      ...
      body: [
        ...
        new Image({
          src: dbSettings,
          caption:
            'My database settings in production using dj_database_url library.',
        }),
        new Paragraph({
        ...
        new Image({
          src: dbRequirements,
          caption:
            'Requirements necessary to run PostgreSQL on Heroku, which are psycopg2 and dj_database_url',
        }),
        new Paragraph({
    ...
    },
    {
      ...
      body: [
        ...
        new Image({
          src: herokuIamAccess,
          caption:
            'Put AWS IAM user access keys into the environment variables on Heroku',
        }),
        new Paragraph({
        ...
        new Image({
          ...
          caption:
            'Add the S3 bucket name to the list of Heroku environment variables',
        }),
        new Paragraph({
