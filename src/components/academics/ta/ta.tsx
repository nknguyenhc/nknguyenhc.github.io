...
const TaPosition = ({ data }: { data: TaDataType }): JSX.Element => {
    ...
    >
      ...
      <div className="ta-data">
        <div className="ta-data-title">
          <div className="ta-data-title-name">
        ...
        <div className="ta-data-details">
          <div className="ta-data-details-block">
            <div>
              Teaching feedback score: {data.rating}/5.0 (Department average:{' '}
              {departmentAverage[data.term]}/5.0)
            </div>
            <div>
              View{' '}
              <a
                href={`${process.env.PUBLIC_URL}/TA/${data.name}.pdf`}
                className="ta-data-details-link"
              >
                full report
              </a>
              .
          ...
          <div className="ta-data-details-block">
            ...
            <div className="ta-data-details-topics">
              {data.topics.map((topic) => (
                <div key={topic} className="ta-data-details-topic">
                  {topic}
                </div>
              ))}
            </div>
...
const BulletListing = (): JSX.Element => <div className="ta-bullet" />;
